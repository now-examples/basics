<template>
  <main>
    <h1>Gridsome + Node.js (TypeScript) API</h1>
    <h2>
      Deployed with
    ...
    <p>
      <a
        href="https://github.com/zeit/now-examples/blob/master/gridsome-node-typescript"
        target="_blank"
...
<script>
export default {
  name: "Gridsome + Node.js (TypeScript) API",
  metaInfo: {
    title: "Gridsome + Node.js (TypeScript) API"
  },
  props: {
    date: String
  },
