...
function Index() {
  ...
  useEffect(() => {
    async function getDate() {
      const res = await fetch('/api/date.py');
  ...
  return (
    <main>
      <Head>
        <title>Next.js + Python API</title>
      </Head>
      ...
      <p>
        <a
          href="https://github.com/zeit/now-examples/blob/master/nextjs-python"
          target="_blank"
          rel="noreferrer noopener"
        >
          This project
        ...
        contains a serverless <a href="https://www.python.org/">Python</a>{' '}
        function. See{' '}
        <a href="/api/date.py">
