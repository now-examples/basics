...
class MyApp extends PolymerElement {
  static get template() {
    return html`
      ...
      <main>
        <h1>Polymer + Node.js (TypeScript) API</h1>
        <h2>
          Deployed with
          <a
        ...
        <p>
          <a
            href="https://github.com/zeit/now-examples/blob/master/polymer-node-typescript"
            target="_blank"
            rel="noreferrer noopener"
            >This project</a
          >
          ...
          function. See
          <a href="/api/date">
            <code>api/date</code> for the Date API with Node.js (TypeScript)</a
          >.
        </p>
        <br />
