...
class Home extends Component {
  ...
  render() {
    ...
    return (
      <main>
        <h1>Preact + Node.js (TypeScript) API</h1>
        <h2>
          Deployed with{' '}
          <a
        ...
        <p>
          <a
            href="https://github.com/zeit/now-examples/blob/master/preact-node-typescript"
            target="_blank"
            rel="noreferrer noopener"
          >
            This project
          ...
          <a href="https://nodejs.org/en/">Node.js (TypeScript)</a> function.
          See{' '}
          <a href="/api/date">
