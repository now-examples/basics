  ...
  switch (type) {
    case "maki":
      return {
        ...
        pictureURL: "https://www.maxpixel.net/static/photo/2x/Raw-Salmon-Rice-Maki-Fish-Sushi-716433.jpg",
        title: "Maki",
      };
    case "temaki":
      return {
        ...
        pictureURL: "https://www.publicdomainpictures.net/pictures/270000/velka/japanese-food.jpg",
        title: "Temaki",
      };
    case "uramaki":
      return {
        ...
        pictureURL: "https://c1.staticflickr.com/1/772/20940700515_865e26d4a0_b.jpg",
        title: "Uramaki",
      };
    case "nigiri":
      return {
        ...
        pictureURL: "https://www.maxpixel.net/static/photo/2x/Fish-Salmon-Raw-Nigiri-Rice-Sushi-716430.jpg",
        title: "Nigiri",
      };
    case "sashimi":
      return {
